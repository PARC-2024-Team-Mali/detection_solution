function instanceCoordinates = getWeedsCoordinates(RGBImage, projectionMatrix)
    % Apply a color mask based on HSV color space
    [imageBW, ~] = hsvMask(RGBImage);
    ...
    % After the above code run, weeds are not consistent objects in "imageBW". 
    ...
    for i = 1:numInstances
        ...
        [u, v] = ind2sub(size(imageBW), pixelIndices);
